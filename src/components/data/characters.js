...
// TODO: Change naming convention text. Change name examples to some from Eorzea Encyclopedia.
// TODO: Condense naming convention text. It's too lengthy for an introductory site.
...
export const playableRaces = [
    {
        ...
        namingConvention: `Midlander names are based on Anglo Saxon, Celtic, and Briton names from medieval Europe. (ex: Eddard Baker, 
                           Joyse Brown, Rauffe Shepard) Highlander names are based in Germanic or Norman roots.(ex: Aethlwold Hunter, 
                           Sigberta Strong)`,
    ...
    },
    {
        ...
        namingConvention: `Wildwood and Duskwight Elezen names are based on French. 
    ...
    },
    {
        ...
        namingConvention: `Roegadyn names are self chosen, and are a descriptor followed by a noun. Sea Wolves
                           use the ancestral Roegadyn language for their names (inspired by Germanic languages) (ex: Merlwyb Bloefhiswyn, 
                           Ghimswys Saesraenwyn). Hellsguard use similar naming conventions but translated to Eorzean (English) (ex: Tall 
                           Mountain, Diving Sparrow).`,
    ...
    },
    {
        ...
        namingConvention: `Lalafell names have heavy use of rhyme, rhythm, repetition, and alliteration. There are four specific phoneme
                           patterns used. Plainsfolk males and females use patterns AB-CB and ABB-AB respectively (ex: Alka Zolka, Ulala Ula ). 
                           Dunesfolk males and feamles use patterns AAB-CCB and AAB-AB respectively (ex: Jajariku Nanariku, Jajano Jano).`,
    ...
    },
    {
        ...
        namingConvention: `Every Seeker of the Sun first name is preceded by a letter representing their tribe followed by an apostrophe 
                           and then their first name. Male Seekers have one of two last names, "Nunh" for breeding males or "Tia" for all 
                           others. Female Seekers take their father's first name as their last name. (ex: K'tyaka Nunh, N'bolata Raha) 
                           Keepers of the Moon pass their mother's their children. Female Keepers get a unique first name with their 
                           mother's last name, while all males take their mother's first and last name with a suffix that determines 
                           which number son they are by birth (first son up to tenth). (ex: Gota Jaab, Gota'li Jaab)
    ...
    },
    {
        ...
        namingConvention: `Au Ra often take names from Hyur living in the same area. Hailing from the east, Raen names are based on 
                           Japanese names while Xaela names are based on Mongolian. Au Ra that grew up in other regions tend to have 
                           names typical to that region. (Raen ex: Tsukikage Urabe, Kurenai Shisui) (Xaela ex: Iturgen Qestir, Sadu Dotharl)`,
    ...
    },
    {
        ...
        namingConvention: `Viera have multiple names throughout their lives. The 
                           names their parents give them, the names they choose when they reach adulthood, and names they choose should 
                           they leave their homeland. When residing in their homeland, Viera have a "forest name" which resemble 
                           real-world Scandinavian names. If they choose to leave their home and explore the wider world, they abandon 
                           their "forest name" and choose a "city name" based on things they like or based on the names from other 
                           races they encounter. (Rava ex: Ysera Bysnoe, Qestra Djt-Marouc) (Veena ex: Sonja Ymir, Arjm Huorlwesfv)`,
    ...
    },
    {
        ...
        namingConvention: `Hrothgar first names are based on Slavic names. Helion lastnames, are based on the queen they served.
                           ...
                           end with 'sch', which means 'lost'. (ex: Balsaljen Ulgasch, Marsak Apella, and Radovan Slobasch)`,
        art: hrothgarMaleArt
